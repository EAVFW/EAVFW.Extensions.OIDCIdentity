...
{
    //public class EAVFWOpenIddictServerFactory : IOpenIddictServerFactory
    //{
    ...
    //    public EAVFWOpenIddictServerFactory(ILogger<OpenIddictServerDispatcher> logger, IOptionsSnapshot<OpenIddictServerOptions> options)
    //    {
